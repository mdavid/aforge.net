...
namespace AForge.Genetic
{
    ...
    public class EliteSelection : ISelectionMethod
    {
        ...
        /// </summary>
        ///
        /// <remarks>If the value is <see langword="false"/>, then the resulting new
        /// generation is sorted in the descending order. If the value is <see langword="true"/>,
        /// then the new generation is shuffled.</remarks> 
        ///
        public bool Shuffle
        {
            get { return shuffle; }
