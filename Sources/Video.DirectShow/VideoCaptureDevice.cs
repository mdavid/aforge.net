...
namespace AForge.Video.DirectShow
{
    ...
    /// <summary>
    /// Video source from local video capture device (for example USB webcam).
    /// </summary>
    /// 
    /// <remarks><para>The video source captures video data from local video capture device.</para>
